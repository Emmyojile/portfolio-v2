  ...
  return (
    <section id="testimonials" className="pt-32 pb-16">
        ...
        >
            ...
            <p className="mt-10">
            As a Full Stack Developer, I bring a versatile set of skills to the table. From crafting interactive front-end interfaces that captivate users to engineering robust
            </p>
        </motion.div>
